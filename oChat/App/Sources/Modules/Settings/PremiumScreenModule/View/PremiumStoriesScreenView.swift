//
//  PremiumStoriesScreenView.swift
//  oChat
//
...
struct PremiumStoriesScreenView: View {
  ...
  private let storiesType: PremiumStoriesScreenModel
  ...
  public init(
    ...
    title: String,
    subtitle: String,
    storiesType: PremiumStoriesScreenModel
  ) {
...
private extension PremiumStoriesScreenView {
  @ViewBuilder
