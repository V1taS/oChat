...
final class AuthenticationFlowCoordinator: Coordinator<AuthenticationScreenState, AuthenticationFinishFlowType> {
  
  // MARK: - Internal variables
  
  var viewController: UIViewController?
  let openType: AuthenticationFlowOpenType
  ...
  override func start(parameter: AuthenticationScreenState) {
