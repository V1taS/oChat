...
/// Модель `oChatModel` представляет основную структуру данных для хранения информации о кошельках и настройках приложения.
...
public struct oChatModel {
  ...
  /// Инициализирует новый экземпляр `oChatModel` с указанными настройками приложения и кошельками.
  ///
  /// - Parameters:
...
extension oChatModel: IdentifiableAndCodable {}
