  ...
  private var buttons: [AnyView] {
    ...
    if message.status == .error {
      buttons.append(AnyView(
        menuButton(
          title: SKChatStrings.messageMenuRetryTitle,
    ...
    if !message.text.isEmpty {
      buttons.append(AnyView(
        menuButton(
          title: SKChatStrings.messageMenuReplyTitle,
      ...
      buttons.append(AnyView(
        menuButton(
          title: SKChatStrings.messageMenuCopyTitle,
    ...
    buttons.append(AnyView(
      menuButton(
        title: SKChatStrings.messageMenuDeleteTitle,
