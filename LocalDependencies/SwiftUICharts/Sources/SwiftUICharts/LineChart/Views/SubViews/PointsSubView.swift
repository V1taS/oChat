...
internal struct PointsSubView<DS>: View where DS: CTLineChartDataSet,
    ...
    internal var body: some View {
        ...
        case .filled:
            ...
            .if(disableAnimation != nil, transform: { view in
              view
                .animateOnAppear(disabled: disableAnimation, using: animation ?? .default) {
                    self.startAnimation = true
                }
            })
            .if(disableAnimation != nil, transform: { view in
              view
                .animateOnDisappear(disabled: disableAnimation, using: animation ?? .default) {
