...
extension UIViewController {
  ...
  /// Представляет текущий контроллер как шторка с возможностью установить размер шторки
  public func presentBottomSheet(
    _ viewControllerToPresent: UIViewController,
    detents: [UISheetPresentationController.Detent] = [],
    targetHeight: CGFloat? = nil
  ) {
    let viewController = viewControllerToPresent
    viewController.modalPresentationStyle = .pageSheet
    var detents: [UISheetPresentationController.Detent] = detents
